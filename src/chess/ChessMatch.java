...
public class ChessMatch {
	...
	private List<Piece> plecesOnTheBoard = new ArrayList<>();
	...
	private  Piece makeMove(Position source, Position target) {
		...
		if(capturedPiece != null) {
			plecesOnTheBoard.remove(capturedPiece);
	...
	private void validateTagetPosition(Position source,Position target) {
		if(!board.piece(source).possibleMove(target)) {
			throw new ChessException("The chosen piece can 't move to target positio");
		}
	}
